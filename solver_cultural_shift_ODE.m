...
% N1 and N2 parameters
  ...
  r1 = 0;       % N1 growth
  rho = 0.005;  % fitness advantage of practice
  ...
  alpha3 = pp(i)*alpha1; % social learning N2 -> N3 set this at 0.1*alpha1 when rho is preturbed
...
for i = 1:length(pp)
    ...
    %plot(time{i},N2 ,string(sty(i)),'DisplayName',txt,'color',[0.8500 0.3250 0.0980],'Linewidth',2) % plot populations when perturbing rho
    plot(time{i},N2 ,string(sty(i)),'DisplayName',txt,'color','k','Linewidth',2) % plot populations when perturbing alpha1
